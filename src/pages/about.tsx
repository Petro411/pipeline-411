...
const AboutUs = ({ faqs }: Props) => {
  return (
    <>
      <SeoHead
        title="About Pipeline411 | Mineral Owner Data for Landmen"
        description="Pipeline411 is built by landmen, for landmen — delivering accurate, verified mineral owner contact data to power faster, smarter land acquisition."
        url="https://www.Pipeline411.com/about"
        faqs={faqs}
      />
      <SiteHeader />
