...
const ContactPage = ({ faqs }: { faqs: any[] | [] }) => {
  ...
  return (
    <>
      <SeoHead
        title="Contact Us | Pipeline411"
        description="Have questions or need assistance? Reach out to the Pipeline411 team for support, inquiries, or feedback. We're here to help you with your mineral owner data needs."
        url="https://www.Pipeline411.com/contact"
        faqs={faqs}
        allowIndexing={true}
      />
      <SiteHeader />
