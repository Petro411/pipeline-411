export default {
    ...
    HowItWorksDes: "Pipeline411 is the first surface owner database to utilize government property records from specific Counties and merge them with current phone numbers and emails.",
