...
/**
 * SeoHeadPricing — reusable Head component for Pipeline411 Pricing page
...
export default function SeoHeadPricing({
    ...
    plans.length > 0
      ? {
          ...
          itemListElement: plans.map((plan, index) => ({
            ...
            item: {
              "@type": "Product",
              name: `Pipeline411 ${plan.title} Plan`,
              description:
                plan.description ||
                (plan.features && plan.features.length > 0
                  ? plan.features.join(", ")
                  : `${plan.title} subscription plan on Pipeline411.`),
              brand: {
                "@type": "Brand",
                name: "Pipeline411",
              },
  ...
  return (
    <Head>
      ...
      <meta
        property="og:image"
        content="https://www.Pipeline411.com/assets/images/cover-bg.png"
      />
